...
public class SpUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME ="LonchCloud";
    static Context context = LonchCloudApplication.getApplicationsContext();
    private static MMKV preferences = MMKV.mmkvWithID("LonchCloud");

    static {
        SharedPreferences old_man = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
